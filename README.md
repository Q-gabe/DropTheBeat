...
<h3 align="center">Share your audio-visual experiences wherever you are.</h3>
...
## _Drop The Beat_ - Redefining how we share the music we love.
...
So have we! For [**Hack'n'Roll 2020**](https://hacknroll.nushackers.org/), our team built an application that enables anyone to share that audio-visual experience with others easily on the go. And so we proudly we present our multi-platform mobile application **Drop The Beat**!
...
* **Song search powered by Spotify** :musical_note:
	* Choose from the entire 50+ million songs available from Spotify to _drop_!
...
We welcome contributors to work on _Drop The Beat_ together with us! Feel free to make various improvements as you see fit, no matter how small! However, changes will be subject to approval through pull requests.
...
## Hackathon and Learning Experience
